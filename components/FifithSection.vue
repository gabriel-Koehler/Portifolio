<template>
    <div id="ContactMe"
        class="w-full pt-20 h-screen flex items-center justify-evenly bg-cover bg-center bg-[url('public/gradientFooter.svg')]">
        <div class="flex-col">

            <div class="font-Questrial text-[6vw]  flex pb-20 text-white">
